...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage Unit</h6>
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
            <button class="btn btn-sm btn-outline--primary addUnit"><i class="las la-plus"></i>Add New</button>
    </div>
</div>
                                            ...
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary updateUnit" data-id="1"
                                                    ...
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                        ...
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/courier/manage/status/1"
                                                        data-question="Are you sure to disable this unit?">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary updateUnit" data-id="2"
                                                    ...
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/courier/manage/status/2"
                                                        data-question="Are you sure to disable this unit?">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary updateUnit" data-id="3"
                                                    ...
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/courier/manage/status/3"
                                                        data-question="Are you sure to disable this unit?">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
    ...
    <div id="unitModel" class="modal fade">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="https://script.viserlab.com/courierlab/demo/admin/courier/manage/unit/store" class="resetForm" method="POST">
