                ...
                <div class="card-body p-0">
                    <div class="table-responsive--md table-responsive">
                        <table class="table--light style--two table">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td><span>Finn Cooke</span></td>
                                        <td><span>vagyfaxuf</span></td>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b7c5d8c7d6c5f7c3d2c4c399d4d8da">[email&#160;protected]</a></td>
                                                                                    <td>
                                                                                                    <div class="button--group">
                                                        <button class="btn btn-sm btn-outline--primary editBtn" data-name="Finn Cooke"
                                                            data-username="vagyfaxuf" data-email="ropar@test.com"
                                                            data-id="10">
                                                            <i class="la la-pen"></i>Edit                                                        </button>
                                                        <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-action="https://script.viserlab.com/courierlab/demo/admin/remove/10" data-question="Are you sure to remove this admin?">
                                                            <i class="las la-trash"></i> Delete                                                        </button>
                                                    </div>
                                                                                            </td>
                                                                            </tr>
                                                                    <tr>
                                        <td><span>Imogene Tyler</span></td>
                                        <td><span>guhefi</span></td>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="74070d0215171d100134001107005a171b19">[email&#160;protected]</a></td>
                                                                                    <td>
                                                                                                    <div class="button--group">
                                                        <button class="btn btn-sm btn-outline--primary editBtn" data-name="Imogene Tyler"
                                                            data-username="guhefi" data-email="syvacidu@test.com"
                                                            data-id="9">
                                                            <i class="la la-pen"></i>Edit                                                        </button>
                                                        <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-action="https://script.viserlab.com/courierlab/demo/admin/remove/9" data-question="Are you sure to remove this admin?">
                                                            <i class="las la-trash"></i> Delete                                                        </button>
                                                    </div>
                                                                                            </td>
                                                                            </tr>
                                                                    <tr>
                                        <td><span>Md New Admin</span></td>
                                        <td><span>newadmin</span></td>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4e202b392f2a2327200e29232f2722602d21237f">[email&#160;protected]</a></td>
                                                                                    <td>
                                                                                                    <div class="button--group">
                                                        <button class="btn btn-sm btn-outline--primary editBtn" data-name="Md New Admin"
                                                            data-username="newadmin" data-email="newadmin@gmail.com1"
                                                            data-id="8">
                                                            <i class="la la-pen"></i>Edit                                                        </button>
                                                        <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-action="https://script.viserlab.com/courierlab/demo/admin/remove/8" data-question="Are you sure to remove this admin?">
                                                            <i class="las la-trash"></i> Delete                                                        </button>
                                                    </div>
                                                                                            </td>
                                                                            </tr>
                                                                    <tr>
                                        <td><span>Super Admin</span></td>
                                        <td><span>admin</span></td>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8aebeee7e3e4caf9e3feefa4e9e5e7">[email&#160;protected]</a></td>
                                                                                    <td>
                                                                                            </td>
                                                                            </tr>
                                                            </tbody>
    ...
    <div class="modal fade" id="manageAdmin">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="resetForm" action="https://script.viserlab.com/courierlab/demo/admin/store" method="post">
                    <input type="hidden" name="_token" value="qCBWlbNxa5THzJiZQHtGIyHBhtJwhhLoG8TwosWw" autocomplete="off">                    <input name="id" type="hidden">
