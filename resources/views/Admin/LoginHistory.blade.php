                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">FedEx Company</span>
                                                                                            <span class="small d-block"> <a
                                                        href="https://script.viserlab.com/courierlab/demo/admin/staff?search=staff"><span>@</span>staff</a>
                                                </span>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/103.16.69.134">
                                                    103.16.69.134
                                                </a>
                                            </span>
                                        </td>
                                        <td>Bengaluru <br> India</td>
                                        <td>Chrome <br> Windows 10</td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">satyam k</span>
                                                                                            <span class="small d-block"> <a
                                                        href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/edit/21"><span>@</span>manager</a>
                                                </span>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/2001:861:38c5:ea40:c826:278a:8eea:fda6">
                                                    2001:861:38c5:ea40:c826:278a:8eea:fda6
                                                </a>
                                            </span>
                                        </td>
                                        <td>Noisy-le-Sec <br> France</td>
                                        <td>Firefox <br> Mac OS X</td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">FedEx Company</span>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/105.112.221.178">
                                                    105.112.221.178
                                                </a>
                                            </span>
                                        </td>
                                        <td>Benin City <br> Nigeria</td>
                                        <td>Handheld Browser <br> Android</td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">FedEx Company</span>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/102.90.46.89">
                                                    102.90.46.89
                                                </a>
                                            </span>
                                        </td>
                                        <td>Port Harcourt <br> Nigeria</td>
                                        <td>Handheld Browser <br> iPhone</td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">satyam k</span>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/125.160.233.254">
                                                    125.160.233.254
                                                </a>
                                            </span>
                                        </td>
                                        <td>Jakarta <br> Indonesia</td>
                                        <td>Chrome <br> Mac OS X</td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">FedEx Company</span>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/2001:861:38c5:ea40:4cf5:14cf:7376:c19f">
                                                    2001:861:38c5:ea40:4cf5:14cf:7376:c19f
                                                </a>
                                            </span>
                                        </td>
                                        <td>Noisy-le-Sec <br> France</td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/2405:6581:9120:800:2422:7728:10dd:f33c">
                                                    2405:6581:9120:800:2422:7728:10dd:f33c
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/196.112.77.126">
                                                    196.112.77.126
                                                </a>
                                            </span>
                                        </td>
                                        <td>Casablanca <br> Morocco</td>
                                        <td>Chrome <br> Windows 10</td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/ipHistory/105.112.116.121">
                                                    105.112.116.121
                                                </a>
                                            </span>
                                        </td>
                                        <td>Abuja <br> Nigeria</td>
                                        <td>Chrome <br> Windows 10</td>
                                    </tr>
                                                            </tbody>
                        </table>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div>
                <p class="small text-muted">
                    ...
                    of
                    <span class="fw-semibold">2721</span>
                    results
                </p>
            </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=2">2</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=3">3</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=4">4</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=5">5</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=6">6</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=7">7</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=8">8</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=9">9</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=10">10</a></li>
                                                    ...
                                                    <li class="page-item disabled" aria-disabled="true"><span class="page-link">...</span></li>
                                                                                                                        ...
                                                                                                                        <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=181">181</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=182">182</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/login/history?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
