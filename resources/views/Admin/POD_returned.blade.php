                                ...
                                <form action="{{ route('trip.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="arrival_proof" name="arrival_proof[]"
                                        ...
                                        <div class="mb-3">
                                            <label for="trip_completion" class="form-label">Completion of
                                                Trip</label>
                                            <select id="trip_completion" name="trip_completion" class="form-control"
                                                required>
                                ...
                                <option value="POD Return">POD Return</option>
                                      ...
                                      <!--  <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="plate_number" name="plate_number" class="form-control"
                                                required>
                                ...
                                <form id="editForm" action="{{ route('trip.update', 0) }}" method="POST"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="editArrivalProof" name="arrival_proof"
                                                class="form-control">
                                        ...
                                        <div class="mb-3">
                                            <label for="editTripCompletion" class="form-label">Completion of
                                                Trip</label>
                                            <select id="editTripCompletion" name="trip_completion"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="editCloseTrip" name="close_trip" class="form-control"
                                                required>
