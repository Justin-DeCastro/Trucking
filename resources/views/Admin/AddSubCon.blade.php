...
<body>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('subcontractors.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="company-name" class="form-label">Company Name</label>
                            <input type="text" id="company-name" name="company_name" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label for="subcontractor-id" class="form-label">Subcontractor ID</label>
                            <input type="text" id="subcontractor-id" name="subcontractor_id" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
