...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage Courier Type</h6>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td><span class="fw-bold">Food</span></td>
                                        <td><span>KG</span></td>
                                        <td>
                                            <span>$10.00</span>
                                        </td>
                                        <td>
                                            <span class="badge badge--success">Enabled</span>                                        </td>
                                        <td>
                                            <span class="d-block">2022-11-12 01:20 PM</span>
                                            <span>1 year ago</span>
                                        </td>
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary  updateUnit" data-id="1"
                                                    data-name="Food" data-price="10"
                                                    data-unit="1"><i class="las la-pen"></i>Edit</button>

                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/courier/manage/type/status/1"
                                                        ...
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                    ...
                                                                    <tr>
                                        <td><span class="fw-bold">Oil</span></td>
                                        ...
                                        <td>
                                            <span class="badge badge--success">Enabled</span>                                        </td>
                                        <td>
                                            <span class="d-block">2022-11-12 01:21 PM</span>
                                            <span>1 year ago</span>
                                        </td>
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary  updateUnit" data-id="2"
                                                    data-name="Oil" data-price="5"
                                                    data-unit="2"><i class="las la-pen"></i>Edit</button>

                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/courier/manage/type/status/2"
                                                        data-question="Are you sure to disable this type?">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                                                    ...
                                                                    <tr>
                                        <td><span class="fw-bold">Wood</span></td>
                                        <td><span>MITER</span></td>
                                        <td>
                                            <span>$10.00</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary  updateUnit" data-id="3"
                                                    data-name="Wood" data-price="10"
                                                    data-unit="3"><i class="las la-pen"></i>Edit</button>

                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/courier/manage/type/status/3"
                                                        data-question="Are you sure to disable this type?">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Update Courier Type</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                    </button>
                </div>
                <form action="https://script.viserlab.com/courierlab/demo/admin/courier/manage/type/store" method="POST">
                    <input type="hidden" name="_token" value="Rpu75LKLzzQp9rOJGk64ktuEb6Xif8pTDhlhn5o1" autocomplete="off">                    <input type="hidden" name="id">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST">
                <input type="hidden" name="_token" value="Rpu75LKLzzQp9rOJGk64ktuEb6Xif8pTDhlhn5o1" autocomplete="off">                <div class="modal-body">
                    <p class="question"></p>
                </div>
                <div class="modal-footer">
