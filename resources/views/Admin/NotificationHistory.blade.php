                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>
                                                                                            <span class="fw-bold">Abis Abis</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=abisanth"><span>@</span>abisanth</a>
                                                    </span>
                                        ...
                                        <td>
                                                                                            Staff Create Courier lab
                                                                                    </td>
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/17"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">Tharindu Karunawedi</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=wedi"><span>@</span>wedi</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/16"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">adam scott</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=staffss"><span>@</span>staffss</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/15"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">Gul Khan</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=gulkhan"><span>@</span>gulkhan</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/14"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">abdul qadeer</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=abdulqadeer"><span>@</span>abdulqadeer</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/13"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">khan gul</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=khangul"><span>@</span>khangul</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/12"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">Saad Farooq</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=saadf6826"><span>@</span>saadf6826</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/11"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">RAJ KUMAR</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=admin1414"><span>@</span>admin1414</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/10"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">KOKO KOKO</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=KOKO"><span>@</span>KOKO</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/9"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">sadaa dsadasa</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=cargomargo"><span>@</span>cargomargo</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/8"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">Khan Baba</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=khanbaba"><span>@</span>khanbaba</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/7"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">Jiyaul Haq</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=fdaaffaaf"><span>@</span>fdaaffaaf</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/6"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">winnie winnie</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=win"><span>@</span>win</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/5"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">Polash Roy</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=polash0409"><span>@</span>polash0409</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/4"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                        <tr>
                                        <td>
                                                                                            <span class="fw-bold">JENNIFER asds</span>
                                                                                                    <span class="small d-block"> <a
                                                            href="https://script.viserlab.com/courierlab/demo/admin/staff?search=customer"><span>@</span>customer</a>
                                                    </span>
                                                                                                <span class="d-block">Staff</span>
                                                                                    </td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                data-type="email"
                                                 data-message="https://script.viserlab.com/courierlab/demo/admin/report/email/detail/3"  data-sent_to="[Email is protected for the demo]">
                                                <i class="las la-desktop"></i> Detail                                            </button>
                                        </td>
                                    </tr>
                                                                    </tbody>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/notification/history?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/notification/history?page=2">2</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/report/notification/history?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
