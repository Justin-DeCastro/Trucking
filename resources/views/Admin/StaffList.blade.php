...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">All Staff List</h6>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td><span class="fw-bold">Singapore</span></td>
                                        <td>
                                            <span class="fw-bold">FedEx Company</span>
                                            <br>
                                            <span class="small">
                                                <span>@</span>staff
                                            </span>
                                        ...
                                        <td>
                                            <span class="fw-bold">[Email is Protected for the demo]<br>[Mobile is protected for the demo]</span>
                                        </td>
                                        <td>
                                            2022-11-12 01:28 PM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/23"
                                        ...
                                        <td>
                                            <span class="fw-bold">India staff</span>
                                            <br>
                                            <span class="small">
                                                <span>@</span>cstaff
                                            </span>
                                        ...
                                        <td>
                                            2022-11-12 01:29 PM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/24"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td><span class="fw-bold">India</span></td>
                                        <td>
                                            <span class="fw-bold">India Daniel</span>
                                            <br>
                                            <span class="small">
                                                <span>@</span>tezity
                                            </span>
                                        ...
                                        <td>
                                            2022-11-12 07:47 PM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/25"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td><span class="fw-bold">Singapore</span></td>
                                        <td>
                                            <span class="fw-bold">USA USA</span>
                                            <br>
                                            <span class="small">
                                                <span>@</span>stafffff
                                            </span>
                                        ...
                                        <td>
                                            2022-12-27 05:57 PM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/26"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td><span class="fw-bold">Singapore</span></td>
                                        <td>
                                            <span class="fw-bold">stafi stafi</span>
                                            <br>
                                            <span class="small">
                                                <span>@</span>stafi
                                            </span>
                                        ...
                                        <td>
                                            2022-12-27 06:03 PM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/27"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-02-05 09:38 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/28"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-02-12 03:58 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/29"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-02-19 10:30 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/30"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-03-09 12:21 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/31"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-03-10 07:52 PM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/32"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-03-12 10:08 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/33"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-03-16 08:33 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--warning">Disabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/34"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-05-14 02:06 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/35"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-05-27 01:22 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/36"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            2023-06-25 11:21 AM <br>
                                            1 year ago
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span> </td>
                                        <td>
                                            <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/staff/dashboard/37"
                                                class="btn btn-sm btn-outline--success" target="_blank">
                                                <i class="las la-sign-in-alt"></i>
                                                Login                                            </a>
                                        </td>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/staff?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/staff?page=2">2</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/staff?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
