    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="https://script.viserlab.com/courierlab/demo/admin/dashboard" class="sidebar__main-logo">
                <img src="https://script.viserlab.com/courierlab/demo/assets/images/logo_icon/logo.png" alt="image"></a>
        </div>
            ...
            <ul class="sidebar__menu">
                        ...
                        <div class="sidebar-submenu sidebar-submenu__open ">
                            <ul>
                                        ...
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/branch" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Manage Branch</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/branch-manager/list" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Branch Manager</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/courier/branch/income" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <div class="sidebar-submenu  ">
                            <ul>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/courier/manage/unit" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Manage Unit</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/courier/manage/type" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <div class="sidebar-submenu  ">
                            <ul>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/ticket/pending" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Pending Ticket</span>
                                                                                                                                        <span
                                                    class="menu-badge bg--info ms-auto">32</span>
                                                                                    </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/ticket/closed" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Closed Ticket</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/ticket/answered" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Answered Ticket</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/ticket" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <div class="sidebar-submenu  ">
                            <ul>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/report/login/history" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Login History</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/report/notification/history" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Notification History</span>
                                                                                                            ...
                                                                                                            <li class="sidebar-menu-item ">
                        <a href="https://script.viserlab.com/courierlab/demo/admin/system-setting" class="nav-link ">
                        ...
                        <div class="sidebar-submenu  ">
                            <ul>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/system/info" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Application</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/system/server-info" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Server</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/system/optimize" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Cache</span>
                                                                                                                                </a>
                                    </li>
                                                                                                        <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/courierlab/demo/admin/system/system-update" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
...
<!-- navbar-wrapper end -->
    ...
    <button class="btn  btn-outline--primary h-45 addNewBranch"><i class="las la-plus"></i>Add New</button>
    </div>
</div>
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">Curran</span>
                                            <small class="text-muted"><i>Est quas incididunt</i></span>
                                        </td>
                                        <td>
                                            <span class="d-block"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b5c7ccd8dcf5d8d4dcd9dcdbd4c1dac79bd6dad8">[email&#160;protected]</a></span>
                                            <span>6444564545</span>
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span></td>
                                        <td>
                                            <span class="d-block">2022-11-12 07:28 PM</span>
                                            <span>1 year ago</span>
                                        </td>
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBranch" data-id="4"
                                                    data-name="Curran" data-email="rymi@mailinator.com" data-phone="6444564545"
                                                    data-address="Est quas incididunt">
                                                    <i class="las la-pen"></i>Edit                                                </button>

                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/branch/status/4" data-question="Are you sure to disable this branch?">
                                        ...
                                        <td>
                                            ...
                                            <small class="text-muted"><i>India,India</i></span>
                                        </td>
                                        <td>
                                            <span class="d-block"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="eea7808a878fae9a8b9d9a838f8782c08d8183">[email&#160;protected]</a></span>
                                            <span>54165544545</span>
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span></td>
                                        <td>
                                            <span class="d-block">2022-11-12 01:23 PM</span>
                                            <span>1 year ago</span>
                                        </td>
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBranch" data-id="2"
                                                    data-name="India" data-email="India@testmail.com" data-phone="54165544545"
                                                    data-address="India,India">
                                                    <i class="las la-pen"></i>Edit                                                </button>

                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/branch/status/2" data-question="Are you sure to disable this branch?">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">Singapore</span>
                                            <small class="text-muted"><i>Singapore,Singapore</i></span>
                                        </td>
                                        <td>
                                            <span class="d-block"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4033292e2721302f322500342533342d21292c6e232f2d">[email&#160;protected]</a></span>
                                            <span>102343545</span>
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBranch" data-id="1"
                                                    data-name="Singapore" data-email="singapore@testmail.com" data-phone="102343545"
                                                    data-address="Singapore,Singapore">
                                                    <i class="las la-pen"></i>Edit                                                </button>

                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/branch/status/1" data-question="Are you sure to disable this branch?">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold d-block">Srilanka</span>
                                            <small class="text-muted"><i>Srilanka,Srilanka</i></span>
                                        </td>
                                        <td>
                                            <span class="d-block"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="700302191c111e1b1130041503041d11191c5e131f1d">[email&#160;protected]</a></span>
                                            <span>6444564545</span>
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span></td>
                                        <td>
                                            <span class="d-block">2022-11-12 01:24 PM</span>
                                            <span>1 year ago</span>
                                        </td>
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBranch" data-id="3"
                                                    data-name="Srilanka" data-email="srilanka@testmail.com" data-phone="6444564545"
                                                    data-address="Srilanka,Srilanka">
                                                    <i class="las la-pen"></i>Edit                                                </button>

                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="https://script.viserlab.com/courierlab/demo/admin/branch/status/3" data-question="Are you sure to disable this branch?">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
    ...
    <div id="branchModel" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="https://script.viserlab.com/courierlab/demo/admin/branch/store" class="resetForm" method="POST">
                    <input type="hidden" name="_token" value="qCBWlbNxa5THzJiZQHtGIyHBhtJwhhLoG8TwosWw" autocomplete="off">                    <input type="hidden" name="id">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST">
                <input type="hidden" name="_token" value="qCBWlbNxa5THzJiZQHtGIyHBhtJwhhLoG8TwosWw" autocomplete="off">                <div class="modal-body">
                    <p class="question"></p>
                </div>
                <div class="modal-footer">
