...
<!-- navbar-wrapper end -->
    ...
    <button type="button" class="btn  btn-outline--info h-45 importBtn">
        <i class="las la-cloud-upload-alt"></i> Import    </button>

    <button type="button" class="btn  btn-outline--warning h-45 exportBtn">
        <i class="las la-cloud-download-alt"></i> Export    </button>
    </div>
</div>
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">suwadee becheku</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                                <br>
                                                [Email is Protected for the demo]
                                            </span>
                                        </td>
                                        <td>ที่อยู่ 666 ม.1 ณ.โรงเรียนจีนต้าถง ตำบล เทอดไทย แม่ฟ้าหลวง</td>
                                        <td>Mae Fa Luang</td>
                                        <td>อ่างทอง</td>
                                    </tr>
                                                                    <tr>
                                        ...
                                        <td>อ่างทอง</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">SUFAIL SUFail</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>qkerala</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">SUFAUIL SUFAIL</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>KERALA</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">Tami Nama</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>Center</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">Tah Ngwa</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>North</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">MUKRIM ALI</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>Zanzibar</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">ALI ALI</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>Dar es Salaam</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">sdklknfkjh lfjgsjkh</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>skjdgk</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">sdfh kjsfhkjsh</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>ksjsfgjk</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">Tech Phorix</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>33-Central Commercial Market Model Town Lahore, Pakistan</td>
                                        <td>Lahore</td>
                                        <td>Pakistan</td>
                                    </tr>
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">Emmanuel Abakah</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>bb</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">Joshua Lugu</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
                                        ...
                                        <td>nm</td>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="fw-bold">bjb hjh</span>
                                        </td>
                                        <td>
                                            <span class="fw-bold">
                                                [Mobile is protected for the demo]
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div>
                <p class="small text-muted">
                    ...
                    of
                    <span class="fw-semibold">727</span>
                    results
                </p>
            </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=2">2</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=3">3</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=4">4</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=5">5</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=6">6</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=7">7</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=8">8</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=9">9</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=10">10</a></li>
                                                    ...
                                                    <li class="page-item disabled" aria-disabled="true"><span class="page-link">...</span></li>
                                                                                                                        ...
                                                                                                                        <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=48">48</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=49">49</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/courierlab/demo/admin/customer?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
    ...
    <div class="modal fade" id="importModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="post" action="https://script.viserlab.com/courierlab/demo/admin/customer/import/customers" id="importForm"
                    enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="Q8JtKVy0ZfsrwgJz95ceGumxrAYhpS4zLJ2whlza" autocomplete="off">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="alert alert-warning p-3" role="alert">
                                <p>
                                    The file you wish to upload has to be formatted as we provided template files.Any changes to these files will be considered as an invalid file format. Download links are provided below.                                </p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="fw-bold required" for="file">Select File</label>
                            <input type="file" class="form-control" name="file" accept=".txt,.csv,.xlsx" id="file">
                            <div class="mt-1">
                                <small class="d-block">
                                    Supported files:                                    <b class="fw-bold">csv, excel, txt</b>
                                </small>
                                <small>
                                    Download all of the template files from here                                    <a href="https://script.viserlab.com/courierlab/demo/assets/viseradmin/file_template/sample.csv" title=""
                                        class="text--primary" download="" data-bs-original-title="Download csv file"
                                        target="_blank">
                                        <b>csv,</b>
                                    </a>
                                    <a href="https://script.viserlab.com/courierlab/demo/assets/viseradmin/file_template/sample.xlsx" title=""
                                        class="text--primary" download="" data-bs-original-title="Download excel file"
                                        target="_blank">
                                        <b>excel,</b>
                                    </a>
                                    <a href="https://script.viserlab.com/courierlab/demo/assets/viseradmin/file_template/sample.txt" title=""
                    ...
                    <div class="modal-footer">
                        <button type="Submit" class="btn btn--primary w-100 h-45">Upload</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="exportModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="post" action="https://script.viserlab.com/courierlab/demo/admin/customer/export/customers" id="importForm"
                    enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="Q8JtKVy0ZfsrwgJz95ceGumxrAYhpS4zLJ2whlza" autocomplete="off">                    <div class="modal-body">
                        <div class="form-group">
                            <label class="fw-bold">Export Column</label>
                            <div class="row">
                                        ...
                                        <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                            ...
                                            data-on="Yes" data-off="No" name="columns[]"
                                            value="id"
                                            unchecked>
                                    </div>
                                                                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                data-offstyle="-danger" data-bs-toggle="toggle" data-height="50"
                                data-on="ASC" data-off="DESC" name="order_by">
                        </div>

                        <div class="form-group">
                            <label class="fw-bold">Export Item</label>
