...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">All Branch Manager</h6>
...
<button class="btn btn-outline--primary h-45 addNewBranch" data-bs-toggle="modal" data-bs-target="#branchModel">
                ...
                <div class="card-body  p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                            @foreach ($branchmanager as $managerbranch)
                <tr>
                    <td>{{ $managerbranch->branch }}</td>
                    <td>{{ $managerbranch->name }}</td>
                    <td>{{ $managerbranch->email }}</td>
                    <td>{{ $managerbranch->phone }}</td>
                 
                    @php
    $date = \Carbon\Carbon::parse($managerbranch->date);
@endphp
       ...
       <div id="branchModel" class="modal fade" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('branchmanager.store') }}"
