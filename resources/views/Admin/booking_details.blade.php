                                    ...
                                    <table class="table table--light style--two">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Updated By</th>
                                                <th>Update Status</th> <!-- New column for Updated By -->
                                                <th>Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($rubixdetails as $detail)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($detail->creator)
                                                            Created by: {{ $detail->creator->name }} <!-- Display the name of the user who created the booking -->
                                                            <br>
                                                            Created on: {{ $detail->created_at->format('F d, Y g:i A') }} <!-- Display the date of creation -->
                                                        @else
                                                            Not available
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if ($detail->updater)
                                                            Approved by: {{ $detail->updater->name }} <!-- Display the name of the user who updated the booking -->
                                                            <br>
