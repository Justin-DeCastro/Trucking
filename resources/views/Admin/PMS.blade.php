                                                                        ...
                                                                        <td>
                                                                            @if(is_array($maintenance->proof_of_need_to_fixed))
                                                                                @foreach($maintenance->proof_of_need_to_fixed as $path)
                                                                                    @if(is_string($path))
                                                                                        <img src="{{ asset($path) }}" alt="{{ basename($path) }}" style="max-width: 100px; max-height: 100px;">
                                                                                    @endif
                                                                                @endforeach
                                                                            @endif
                                                                        </td>
    ...
    <div class="modal fade" id="manageAdmin" tabindex="-1" aria-labelledby="manageAdminLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('preventives.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="proof_of_need_to_fixed" class="form-label">Proof of Need to Fixed</label>
                            <input type="file" id="proof_of_need_to_fixed" name="proof_of_need_to_fixed[]" class="form-control" multiple required>
                        </div>

                        <div class="mb-3">
                            <label for="proof_of_payment" class="form-label">Proof of Payment</label>
                            <input type="file" id="proof_of_payment" name="proof_of_payment[]" class="form-control" multiple required>
                        </div>
                    </div>
                    <div class="modal-footer">
