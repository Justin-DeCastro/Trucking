                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="plate_number" name="plate_number" class="form-control" placeholder="Enter plate number" required>
                            </div>
                            <div class="col-md-6">
                                <label for="truck_name" class="form-label">Truck Name</label>
                                <input type="text" id="truck_name" name="truck_name" class="form-control" placeholder="Enter truck name" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="truck_model" name="truck_model" class="form-control" placeholder="Enter truck model" required>
                            </div>
                            <div class="col-md-6">
                                <label for="truck_capacity" class="form-label">Truck Capacity</label>
                                <input type="text" id="truck_capacity" name="truck_capacity" class="form-control" placeholder="Enter truck capacity" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="file" id="or" name="or" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required>
                                <small class="form-text text-muted">Accepted formats: PDF, JPG, JPEG, PNG</small>
                            </div>
                            <div class="col-md-6">
                                <label for="cr" class="form-label">Certificate of Registration (CR)</label>
                                <input type="file" id="cr" name="cr" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required>
                                <small class="form-text text-muted">Accepted formats: PDF, JPG, JPEG, PNG</small>
                            </div>
                        </div>
