    ...
    <div class="truckWrapper">
        <div class="truckBody">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" class="trucksvg">
                ...
                <rect stroke-width="2" stroke="#282828" fill="#282828" rx="1" height="11" width="4"
                    y="81" x="193"></rect>
                <rect stroke-width="3" stroke="#282828" fill="#000B98" rx="2.5" height="90" width="121"
                    y="1.5" x="6.5"></rect>
        ...
        <div class="truckTires">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" class="tiresvg">
                ...
                <circle fill="#e8e8e8" r="7" cy="15" cx="15"></circle>
            </svg>
        </div>
        <div class="road"></div>

        <svg xml:space="preserve" viewBox="0 0 453.459 453.459" xmlns:xlink="http://www.w3.org/1999/xlink"
            xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1" fill="#e8e8e8" class="lampPost">
