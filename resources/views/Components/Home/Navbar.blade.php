        ...
        <div class="col-12">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand logo" href="https://script.viserlab.com/courierlab/demo">
                    <img src="https://script.viserlab.com/courierlab/demo/assets/images/logo_icon/logo.png"  alt="logo image">
                </a>
    ...
    <div class="custom--dropdown">
        ...
        <ul class="dropdown-list">
                        ...
                        <span class="text">Spanish</span>
                                ...
                                <a class="nav-button flex-align btn btn--base" href="https://script.viserlab.com/courierlab/demo/order-tracking"
                                    aria-current="page">
                        ...
                        <li class="nav-item d-lg-block d-none">
                            <a class="nav-button flex-align btn btn--base" href="ordertracking"
                                aria-current="page">
                                <span class="icon"><i class="icon-Product-Box"></i></span>
                                Order Tracking                            </a>
                        </li>
