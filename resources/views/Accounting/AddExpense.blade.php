...
<body>
    ...
    <tbody>
        ...
        <tr>
            <td>₱{{ number_format($expenses->fuel_cost, 2) }}</td>
            <td>₱{{ number_format($expenses->maintenance_repairs, 2) }}</td>
            <td>₱{{ number_format($expenses->tolls_fees, 2) }}</td>
            <td>₱{{ number_format($expenses->driver_expenses, 2) }}</td>
    ...
    <div class="modal fade" id="manageSubcontractor" tabindex="-1" role="dialog" aria-labelledby="manageSubcontractorLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="manageSubcontractorLabel">Trucking Expense Form</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('expense.store') }}" method="post">
                        ...
                        <div class="form-group">
                            <label for="fuel-cost">Fuel Costs ($):</label>
                            <input type="number" id="fuel-cost" name="fuel_cost" step="0.01" required class="form-control">
                        </div>

                        <!-- Maintenance and Repairs -->
                        <div class="form-group">
                            <label for="maintenance-repairs">Maintenance and Repairs ($):</label>
                            <input type="number" id="maintenance-repairs" name="maintenance_repairs" step="0.01" required class="form-control">
                        </div>
                        ...
                        <!-- Tolls and Fees -->
                        <div class="form-group">
                            <label for="tolls-fees">Tolls and Fees ($):</label>
                            <input type="number" id="tolls-fees" name="tolls_fees" step="0.01" required class="form-control">
                        </div>

                        <!-- Driver Expenses -->
                        <div class="form-group">
                            <label for="driver-expenses">Driver Expenses ($):</label>
                            <input type="number" id="driver-expenses" name="driver_expenses" step="0.01" required class="form-control">
                        </div>
