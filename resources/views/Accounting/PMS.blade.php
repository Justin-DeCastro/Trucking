                                ...
                                <div class="table-responsive--md table-responsive">
                                    <div class="d-flex mb-3 align-items-center">
                                        ...
                                        <div class="ms-auto w-100 d-flex justify-content-start">
                                            <form method="GET" action="{{ route('accounting-pms') }}"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('accounting-pms') }}">Select
                                                                Plate Number</a></li>
                                                        @foreach ($plateNumbers as $plateNumber)
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('accounting-pms', ['plate_number' => $plateNumber]) }}">
                                                                    {{ $plateNumber }}
                                                                </a>
                                                            </li>
                                                        @endforeach
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card">
                                                            ...
                                                            <tbody>
                                                                @foreach ($preventive as $maintenance)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ isset($totalKilometersByPlate[$maintenance->plate_number]) ? $totalKilometersByPlate[$maintenance->plate_number] : 'N/A' }}</td>
                                                                        ...
                                                                        <td>₱{{ number_format($maintenance->quantity * $maintenance->price_parts_replaced, 2) }}</td>
                                                ...
                                                </div><!-- Modal for Proof of Payment -->
                                            ...
                                            <div class="modal fade" id="manageAdmin" tabindex="-1"
                                                aria-labelledby="manageAdminLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('preventives.store') }}"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    <label for="plate_number" class="form-label">Plate
                                                                        Number</label>
                                                                    <select id="plate_number" name="plate_number"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="truck_model" class="form-label">Truck
                                                                        Model</label>
                                                                    <input type="text" id="truck_model"
                                                                        name="truck_model" class="form-control"
                                                                        required>
                                                                </div>

                                                                <div class="mb-3">
                                                                    <label for="parts_replaced"
                                                                        class="form-label">Parts Replaced</label>
                                                                    <input type="text" id="parts_replaced"
                                                                        name="parts_replaced" class="form-control"
                                                                        required
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="price_parts_replaced"
                                                                        class="form-label">Price of Parts
                                                                        Replaced</label>
                                                                    <input type="number" id="price_parts_replaced"
                                                                        name="price_parts_replaced"
                                                                        class="form-control"
                                                                        placeholder="Don't use comma" required>
                                                                </div>

                                                                <div class="mb-3">
                                                                    <label for="proof_of_need_to_fixed"
                                                                        class="form-label">Proof of Need to
                                                                        Fixed</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="proof_of_payment"
                                                                        class="form-label">Proof of Payment</label>
                                                                    <input type="file" id="proof_of_payment"
                                                                        name="proof_of_payment[]" class="form-control"
                                                                        multiple required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="truck_model" class="form-label">Truck
                                                                        Model</label>
                                                                    <input type="text" class="form-control"
                                                                        id="truck_model" name="truck_model" required>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="price_parts_replaced"
                                                                        class="form-label">Price of Part</label>
                                                                    <input type="number" class="form-control"
                                                                        id="price_parts_replaced"
                                                                        name="price_parts_replaced" step="0.01"
                                                                        required>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="proof_of_need_to_fixed"
                                                                        class="form-label">Proof of Need to Fix
                                                                        (Images)</label>
                                                                    <input type="file" class="form-control"
                                                                        id="proof_of_need_to_fixed"
                                                                        name="proof_of_need_to_fixed[]" multiple
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="proof_of_payment"
                                                                        class="form-label">Proof of Payment
                                                                        (Images)</label>
                                                                    <input type="file" class="form-control"
                                                                        id="proof_of_payment"
                                                                        name="proof_of_payment[]" multiple
                                                                        accept="image/*" required>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
