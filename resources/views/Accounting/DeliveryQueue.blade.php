...
<head>
    ...
    <title>CourierLab - Delivery In Queue</title>
...
<body>
    ...
    <h6 class="page-title">Delivery In Queue</h6>
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
            <form class="d-flex flex-wrap gap-2">
            <div class="input-group w-auto flex-fill">
    <input type="search" name="search" class="form-control bg--white" placeholder="Courier Code" value="">
    ...
    <div class="modal fade" id="paymentBy">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="https://script.viserlab.com/courierlab/demo/staff/courier/payment" method="POST">
                    <input type="hidden" name="_token" value="iQdGnQclGHVc4Uhh3RU4s02p3rw6e9bJ14kpKP1W" autocomplete="off">                    <input type="hidden" name="_method" value="POST">                    <input type="hidden" name="code">
    ...
    <div class="modal fade" id="deliveryBy">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="https://script.viserlab.com/courierlab/demo/staff/courier/delivery/store" method="POST">
                    <input type="hidden" name="_token" value="iQdGnQclGHVc4Uhh3RU4s02p3rw6e9bJ14kpKP1W" autocomplete="off">                    <input type="hidden" name="_method" value="POST">                    <input type="hidden" name="code">
                    <div class="modal-body">
