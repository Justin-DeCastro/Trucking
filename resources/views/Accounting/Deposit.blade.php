...
<div class="overall-balance" >
    <h4 style="color: #0000ff;">Outstanding Balance: {{ $outstandingBalance }}</h4>
</div>
    ...
    <tbody>
        @foreach($deposits as $deposit)
            <tr>
                ...
                <td></td> <!-- No per-row outstanding balance -->
                <td>{{ $deposit->notes }}</td>
                <td>
        ...
        @foreach($withdraws as $withdraw)
            <tr>
                ...
                <td></td> <!-- No deposit amount for withdrawals -->
                <td>{{ $withdraw->withdraw_amount }}</td>
                <td></td> <!-- No outstanding balance for withdrawals -->
